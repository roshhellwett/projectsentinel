  ...
  return (
    <div className="relative flex items-center gap-1.5">
      ...
      <select
        ...
        className="appearance-none bg-paper border border-rule/60 rounded-sm px-2 py-1 pr-5 font-body text-xs text-muted hover:text-ink cursor-pointer transition-colors"
      >
        {LOCALES.map((l) => (
