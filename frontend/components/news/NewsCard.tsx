      ...
      <div className="relative z-10 flex flex-col flex-1 p-5 md:p-6">
        ...
        <div className="flex items-center justify-between gap-2 mt-4 pt-3 border-t border-slate-100">
          <span className="text-[10px] text-slate-500 inline-flex items-center gap-1">
            ...
            Read full story
            <ExternalLink className="w-3 h-3 opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-200 ease-smooth" />
          </span>
          ...
          <div className="flex items-center gap-1">
            <a
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="p-1.5 -m-1 rounded-full text-slate-400 hover:text-[#25D366] hover:bg-[#25D366]/10 transition-all duration-200 ease-smooth focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]/60"
