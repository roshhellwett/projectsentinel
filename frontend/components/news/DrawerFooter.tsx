...
export function DrawerFooter({ post, siteUrl }: DrawerFooterProps) {
  ...
  return (
    <footer className="flex-shrink-0 border-t border-rule bg-paper-2/70 backdrop-blur-lg px-2.5 sm:px-3 pb-[calc(0.6rem+env(safe-area-inset-bottom,0px))] pt-2.5 sm:pt-3 overflow-hidden">
