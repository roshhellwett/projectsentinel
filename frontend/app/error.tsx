...
export default function Error({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-12 text-center animate-fade-in-up">
      <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-accent-soft/50 border border-accent/20 flex items-center justify-center mb-6 animate-soft-float">
        <AlertOctagon className="w-8 h-8 md:w-10 md:h-10 text-accent" strokeWidth={1.5} />
      </div>
      
      <p className="editorial-kicker mb-3">System error</p>
      ...
      <div className="mt-12 w-full max-w-lg">
        ...
        {showDetails && (
          <div className="mt-4 p-4 rounded-md bg-paper-2 border border-rule text-left overflow-x-auto animate-fade-in-up">
