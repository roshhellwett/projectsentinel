  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 text-center animate-fade-in-up">
      ...
      <div className="flex gap-3">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded border border-rule-strong text-ink text-sm font-semibold hover:border-ink hover:bg-paper-2 hover-lift transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          Go home
        </Link>
      </div>
