  ...
  return (
    ...
    >
      ...
      <p>
        ...
        sources, and uses a large language model to produce a neutral
        summary and a credibility score. We always link back to the original
        publishers — they remain the primary source of record.
      </p>

      <h2>Editorial accuracy</h2>
      <p>
        We work hard to ensure each summary is faithful to its sources, but
        AI systems can make mistakes. If you spot an error, please use the
      ...
      <p>
        Summaries, credibility scores, and editorial copy on India Verified
        are licensed{' '}
      ...
      <p>
        ...
        every summary is error-free or that the site will be available
        without interruption. To the maximum extent permitted by law, we
      ...
      <p>
        India Verified, its operators, and its contributors are not liable
        for indirect, incidental, or consequential damages arising from your
        use of the site. Decisions you make based on information found here
        are your own responsibility — for legal, medical, or financial
