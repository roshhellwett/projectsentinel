    ...
    <LegalPage
      ...
      intro={
        <p>
          ...
          advertising business, no third-party trackers, and we do not run user
          accounts. This document explains exactly what data is touched when you
          visit the site and what your rights are.
        </p>
      }
    >
      ...
      <p>
        ...
        a handful of preferences so the experience feels personal between
        visits:
      </p>
      <ul>
      ...
      <h2>Server logs</h2>
      <p>
        Like any website, our hosting provider records standard request logs (IP
        address, user-agent, requested URL, response code, timestamp). These
        logs are retained for up to 30 days for operational and security
        purposes — diagnosing outages, blocking abuse, and meeting legal
        obligations. They are not used to build advertising profiles and are not
      ...
      <p>
        ...
        remember that you have seen it. We do not embed third-party advertising
        tags, analytics pixels, or social-media trackers.
      </p>
      ...
      <h2>Your rights</h2>
      <p>
        Because no personally identifiable data is collected on our side, there
        is generally nothing for us to delete on your behalf. You can exercise
        complete control by clearing site data in your browser settings.
      </p>

      <h2>Changes to this policy</h2>
      <p>
        If we materially change how data is handled, we will update the
        &ldquo;Last updated&rdquo; date at the top of this page and post a
        notice on the homepage. Continued use of the site after such changes
