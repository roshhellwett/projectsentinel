    ...
    <div className="relative min-h-screen flex items-center justify-center">
      <PageShell className="!px-4 !pb-0">
        <div className="w-full max-w-md mx-auto py-8">
          ...
          <h1 className="text-2xl font-semibold text-center text-ink mb-2">
            Admin Login
          </h1>
          ...
          {error && (
            <div
              role="alert"
              className="mb-4 p-3 bg-red-500/10 border border-red-500/30 text-red-600 rounded-lg text-sm"
            >
              {error}
            </div>
          )}
