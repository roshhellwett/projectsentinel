    ...
    articles = [
        {
            "url_hash": "a",
            "url": "https://example.com/a",
            "headline": "India launches moon mission in historic space achievement",
            "source_name": "SrcA",
        ...
        },
        {
            ...
            "headline": "India moon mission launched in historic space achievement",
            "source_name": "SrcB",
            "source_url": "https://srcb.com",
        },
    ]
    ...
    articles = [
        {
            "url_hash": "a",
            "url": "https://example.com/a",
            "headline": "India launches moon mission",
            "source_name": "SrcA",
            "source_url": "https://srca.com",
        },
        {
            "url_hash": "b",
            "url": "https://example.com/b",
            "headline": "Weather forecast sunny weekend ahead across country",
            "source_name": "SrcB",
            "source_url": "https://srcb.com",
        },
    ]
...
def test_same_source_not_grouped():
    ...
    articles = [
        ...
        },
        {
            "url_hash": "b",
            "url": "https://example.com/b",
            "headline": "India moon mission launched today",
            "source_name": "SameSrc",
            "source_url": "https://same.com",
        },
    ]
    ...
    articles = [
        {
            ...
            "headline": f"Article number {i} with generic words",
            "source_name": f"Src{i}",
